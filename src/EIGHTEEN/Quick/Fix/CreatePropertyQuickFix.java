...
// needs public class in order to be accessed from SEVEN.Annotator.SimpleAnnotator.java
public class CreatePropertyQuickFix extends BaseIntentionAction {
    private String key;

    // needs public class in order to be accessed from SEVEN.Annotator.SimpleAnnotator.java:registerFix(new CreatePropertyQuickFix(key));
